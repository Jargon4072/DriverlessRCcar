...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    # Get lower yellow hue
    lower_yellow_hue = create_hue_mask(hsv_image, [25 ,0,100], [30,255, 255])
    

    # Get higher yellow hue
    higher_yellow_hue = create_hue_mask(hsv_image, [45,0, 100], [60, 255, 255])    
    

    # Merge the images
    full_image = cv2.addWeighted(lower_yellow_hue, 1.0, higher_yellow_hue, 1.0, 0.0)
